...
export default function Home() {
    return (<>
        <div className="text-black font-[family-name:var(--font-raleway)] h-screen flex flex-col md:justify-center items-center text-center md:pt-16">
            ...
            <div className="flex justify-center md:mt-20 overflow-hidden md:object-contain md:w-full">
                <Image
